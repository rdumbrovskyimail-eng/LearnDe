...
class A1DataImporter @Inject constructor(
    ...
    companion object {
        ...
        // Версия ИМПОРТИРУЕМЫХ ассетов (a1/*.json), НЕ версия схемы БД.
        // Бампать только при изменении JSON или полей, которые в них пишутся.
        // Миграция БД 4→5 добавляет лишь runtime-таблицы и импорта не касается.
